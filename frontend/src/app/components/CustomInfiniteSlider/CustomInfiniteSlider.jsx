...
const InfiniteSliderVertical = ({ direction }) => {
  if (direction == "vertical")
    return (
      <div className="flex h-[100%] space-x-4">
        <InfiniteSlider direction={direction}>
          <img
        ...
        <InfiniteSlider direction={direction} reverse>
          <img
  ...
  if (direction == "horizontal") {
    return (
      <div className="flex flex-col gap-3 h-[100%] space-x-4">
        <InfiniteSlider direction={direction}>
          <img
            src="https://i.scdn.co/image/ab67616d00001e02ad24c5e36ddcd1957ad35677"
            alt="Dean blunt - Black Metal 2"
